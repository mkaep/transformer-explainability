...
class MultiHeadAttention(Layer):
  ...
  def _compute_attention(self,
    ...
    attention_scores = tf.einsum(self._dot_product_equation, key,
                                 query)
    # See https://www.tensorflow.org/api_docs/python/tf/shape and
    # https://datascience.stackexchange.com/a/73780 (use tf.shape and not tensor.shape)
    # shape = tf.shape(attention_scores)
    # attention_scores = tf.ones(shape=shape)
